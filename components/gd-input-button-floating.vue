<template>
  <button
    ...
    :class="`${props.icon ? 'gd-input-component-icon' : ''} ${
      props.disabled ? 'gd-input-component-disabled' : ''
    } ${
  ...
  >
    <div v-if="props.icon" class="gd-input-icon-container">
      <gd-svg :name="props.icon" color="secondary" />
    </div>
